...
export const DISPLAY_MODULE_REGISTRY: DisplayModuleDefinition[] = [
  ...
  module("organizeDirectory", "整理目录", "显示待整理、今日新增、链接、图片等整理入口。", ["home", "sidebar", "mobile"], true, ["organizer"], "medium"),
  module("taskDirectory", "任务目录", "显示未完成任务和任务优先级/到期分支。", ["home", "sidebar", "mobile"], true, ["tasks"], "high"),
